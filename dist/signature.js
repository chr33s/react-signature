...
function (_Component) {
  ...
  function Signature(props) {
    ...
    _this = _possibleConstructorReturn(this, (Signature.__proto__ || Object.getPrototypeOf(Signature)).call(this, props));
    Object.defineProperty(_this, "isTouchEvent", {
      configurable: true,
      enumerable: true,
      writable: true,
    ...
    Object.defineProperty(_this, "getCoords", {
      configurable: true,
      enumerable: true,
      writable: true,
      value: function value(e) {
    ...
    Object.defineProperty(_this, "down", {
      configurable: true,
      enumerable: true,
      writable: true,
      value: function value(e) {
        _this.setState({
          path: "".concat(_this.state.path, "M").concat(_this.getCoords(e), " "),
          isDown: true
        });
    ...
    Object.defineProperty(_this, "move", {
      ...
      value: function value(e) {
        if (_this.state.isDown) {
          _this.setState({
            path: "".concat(_this.state.path, "L").concat(_this.getCoords(e), " ")
          });
        }
    ...
    Object.defineProperty(_this, "up", {
      configurable: true,
      enumerable: true,
      writable: true,
      value: function value(e) {
  ...
  _createClass(Signature, [{
    ...
    value: function render() {
      ...
      return _react.default.createElement("div", {
        ...
        className: "clear",
        onClick: this.clear
      }, "Clear"), _react.default.createElement("input", _extends({}, props, {
        value: path,
        type: "hidden",
        pattern: "[ML,0-9 ]".concat(props.required ? '+' : '*')
      })));
    }
  }]);
...
},{"prop-types":11,"react":15}],2:[function(require,module,exports){
"use strict";
...
},{"./checkPropTypes":8,"./lib/ReactPropTypesSecret":12,"_process":7,"fbjs/lib/emptyFunction":2,"fbjs/lib/invariant":4,"fbjs/lib/warning":5,"object-assign":6}],11:[function(require,module,exports){
(function (process){
/**
 * Copyright (c) 2013-present, Facebook, Inc.
 *
...
},{"_process":7,"fbjs/lib/emptyFunction":2,"fbjs/lib/emptyObject":3,"fbjs/lib/invariant":4,"fbjs/lib/warning":5,"object-assign":6,"prop-types/checkPropTypes":8}],14:[function(require,module,exports){
...
},{"fbjs/lib/emptyFunction":2,"fbjs/lib/emptyObject":3,"fbjs/lib/invariant":4,"object-assign":6}],15:[function(require,module,exports){
(function (process){
'use strict';
...
},{"./cjs/react.development.js":13,"./cjs/react.production.min.js":14,"_process":7}]},{},[1]);
